...
function resetCart () {
  ...
  document.querySelector('.js-yes').addEventListener('click', () => {
    ...
    total = 0;
    document.querySelector('.js-total').innerHTML = `Total: $${total}`;
    document.querySelector('.js-warning').innerHTML = ``;
  });
